...
ACCESS_KEY = "ApGwiV5qTwcJUJVfmfm8"
SECRET_KEY = "bFmSmvaWgyhjZqoH1gzUGKqGwcB5flCFUs3uDWLf"
...
if __name__ == '__main__':
    ...
    parser.add_argument('--download_path', default='IRef-VLA_Dataset', help="Directory to store downloaded data.")
